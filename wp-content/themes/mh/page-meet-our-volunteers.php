						...
						echo '<ul id="story">';
							...
							while ( $story_query->have_posts() ) {
								...
								if (!empty($member_image)) {
									...
									$staff_image = '<div class="img"><a href="'.get_permalink().'"><img src="'.site_url().'/wp-content/uploads/pic_stories.jpg" alt="Our Volunteer Photo" /></a></div>';
								}
